        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Form -->
              <form action="student.html" class="d-grid" method="get">
                <label for="name" class="py-2">Name:</label>
                <input type="text" id="name" class="form-control">

                <label for="academy-code" class="py-2">Academy Code:</label>
                <input type="number" id="academy-code" class="form-control">

                <label for="section" class="py-2">Section:</label>
                <input type="number" id="section" class="form-control">

                <label for="department" class="py-2">Department:</label>
                <input type="text" id="department" class="form-control">
                
                <label for="academy-year" class="py-2">Academy Year:</label>
                <input type="number" id="academy-year" class="form-control">

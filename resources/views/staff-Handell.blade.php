...
@section('content')
    ...
    <div class="card">
        ...
        @endif        <div class="card-body">
            ...
            <form action="{{ Route('addstaff') }}" class="d-grid"  enctype="multipart/form-data" method="POST">
                @csrf
                <label for="name" class="py-2">Name:</label>
                <input type="text" id="name" class="form-control" name="name">
                <label for="name" class="py-2">Number Excuse:</label>
                <input type="text" id="name" class="form-control" name="excuse_number">
                <label for="national-id" class="py-2">National ID:</label>
                <input type="number" id="national-id" class="form-control" name="national_id">

...
<head>
    ...
    <title>tableAbsenceStaff-Handell</title>
...
<body>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="assets/img/Mathematics-bro.png" alt="Profile" class="rounded-circle">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">
                                Absence Staff Form</h5>
                            <!-- Form -->
                            <form action="tables-absence-staff.html" class="d-grid" method="get">
                                <label for="name" class="py-2">Name:</label>
                                <input type="text" id="name" class="form-control">

                                <label for="day" class="py-2">Day:</label>
                                ...
                                <label for="state" class="py-2">State:</label>
                                <input type="text" id="state" class="form-control">

                                <label for="excuse" class="py-2">Excuse:</label>
                                <textarea name="" id="excuse" cols="30" rows="3" class="form-control"></textarea>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>حضرني</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->

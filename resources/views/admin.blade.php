    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="assets/img/Mathematics-bro.ico" alt="">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-around border border-dark my-3">
                                <h4 style="color: #3b5c63; font-weight: bold;font-size: 16px;">Add a New Element To A
                                    Table</h4>
                                <a href="admin-handell.html" class="btn btn-success my-2 ms-2"
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Raheem Lehner</td>
                                        <td>Raheem Lehner</td>
                                        <td> <a href="admin-handell.html" class="btn btn-warning my-2 ms-2">update</a>
                                        </td>

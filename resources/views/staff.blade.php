          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-around border border-dark my-3">
                ...
                <a href="staff-Handell.html" class="btn btn-success my-2 ms-2" style="background-color:#74a5af;color:#fff;" >Add new</a>
              </div>
              ...
              <table class="table text-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><img style="width: 100%; height: 50px;" src="assets/img/Mathematics-bro.png" alt=""></td>
                    <td>2011-04-19</td>

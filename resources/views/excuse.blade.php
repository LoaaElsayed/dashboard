          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-around border border-dark my-3">
                ...
                <a href="excuse-Handell.html" class="btn btn-success my-2 ms-2" style="background-color:#74a5af;color:#fff;" >Add new</a>
              </div>
              ...
              <table class="table text-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>47</td>
                    <td>2011-04-19</td>
                    <td> <a href="excuse-Handell.html" class="btn btn-warning my-2 ms-2" >update</a>
                    </td>
                    <td> <a class="btn btn-danger my-2 ms-2" >delete</a>
                    </td>
                  </tr>
                </tbody>
              </table>
